...
export default function WelcomePage() {
	...
	// The first array represents the scroll range. So the transformation is happening between 0 px and 200 px
	// The second array represents the output range. So at 0 px, the opacity is set to 1 and at 200, it's set to 0.5
	// Everything in between is handled by useTransform
